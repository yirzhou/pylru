...
namespace pylru {
template <typename Key, typename Value> class linked_list {
...
template <typename Key, typename Value> linked_list<Key, Value>::linked_list() {
...
template <typename Key, typename Value>
node<Key, Value> *
linked_list<Key, Value>::delete_node(node<Key, Value> *listnode) {
